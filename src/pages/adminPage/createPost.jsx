...
//       {/* 
//           To keep a consistent layout, you can leave space on the left 
//           of each block so that its content is aligned with blocks created from the add area.
//       */}
//       <div className="ml-16 " >
//         {block.type === 'text' && (
//           <ReactQuill
...
//             <FaFont size={20} />
//           </button>
//           <button type="button" onClick={() => { addNewBlock('subTopic'); setShowOptions(false)}} className='px-4 py-2 bg-transparent text-gray-500 rounded'>
...
//                   saving ? 'bg-green-300 cursor-not-allowed' : 'bg-green-500 hover:bg-green-300'
//                 }`}
//               >
...
import ReactQuill from 'react-quill';
import 'react-quill/dist/quill.snow.css';
import { FaFont, FaCamera, FaLink, FaQuoteLeft, FaTable } from 'react-icons/fa';
